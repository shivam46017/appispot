  ...
  const onDelete = async (img) => {
    ...
    try {
      const response = await axios.request({
        method: "DELETE",
        url: `https://many-aerial-innovation-programming.trycloudflare.com/api/delete-bannerbyId/${img._id}`,
      });
      setImages(
        images.filter((e) => {
          return e !== img;
            ...
            <div className="flex items-center gap-3 ">
              <div className="flex h-16 w-16 items-center justify-center">
                <img
                  ...
                  src={`https://many-aerial-innovation-programming.trycloudflare.com${data.coverImage}`}
                  alt=""
                />
              </div>
              <p>Banner Image</p>
