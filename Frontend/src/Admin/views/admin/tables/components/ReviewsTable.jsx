              ...
              return (
                <tr {...row.getRowProps()} key={index}>
                  {row.cells.map((cell, index) => {
                    ...
                    else if (cell.column.Header === "SPOT ID") {
                        data = (
                            <p className="text-sm font-bold text-navy-700 ">
                                {cell.value}
                            </p>
                    ...
                    else if (cell.column.Header === "REVIEWED BY") {
                        data = (
                            <p className="text-sm font-bold text-navy-700 ">
                                {cell.value}
                            </p>
                    ...
                    else if (cell.column.Header === "REMOVE REVIEW") {
                        data = (
                            
                            <MdCancel className="text-red-500 text-xl hover:cursor-pointer" />
                        );
                    }
                    return (
                      <td
