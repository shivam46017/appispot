...
function ReportManagement() {
    ...
    async function fetchBookings() {
        const response = await fetch("https://appispot.com/api/get-all-orders")
    ...
    async function fetchTopSpots() {
        const response = await fetch("https://appispot.com/api/get-most-booked-spots")
        const data = await response.json()
    ...
    async function fetchTopListers(){
      const response = await fetch("https://appispot.com/api/get-most-booked-listers")
      const data = await response.json()
