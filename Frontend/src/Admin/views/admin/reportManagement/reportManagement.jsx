...
function ReportManagement() {
    ...
    async function fetchBookings() {
        const response = await fetch("http://192.168.1.104:5000/api/get-all-orders")
    ...
    async function fetchTopSpots() {
        const response = await fetch("http://192.168.1.104:5000/api/get-most-booked-spots")
        const data = await response.json()
    ...
    async function fetchTopListers(){
      const response = await fetch("http://192.168.1.104:5000/api/get-most-booked-listers")
      const data = await response.json()
