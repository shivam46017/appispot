    ...
    <>
      <section className="text-black body-font lg:px-16">
        <div className="container px-5 py-10 mx-auto">
          <div className="flex flex-wrap w-full mb-20">Filter</div>
          <div className="flex flex-wrap -m-4 justify-center">
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="max-w-sm rounded overflow-hidden shadow-lg relative">
                <div className="absolute p-3 w-full flex justify-between">
                  <span className="text-blue-400 font-medium bg-white rounded-xl p-2 text-sm cursor-pointer">
                    {" "}
                    Featured
                  </span>
                  <AiOutlineHeart className=" border-white text-white  bg-transparent rounded-sm text-3xl cursor-pointer" />
                </div>
                <img
                  className=" h-[42vh] mx-auto w-full hover:scale-105 max-w-xs transition duration-300 ease-in-out "
