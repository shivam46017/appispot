                    ...
                    <main className="">
                        <h1 className="text-sm font-semibold !text-left ml-3 text-white text-center ">
                            Category
                                ...
                                /> */}
                                <select className="bg-transparent block w-full py-0 border-none h-fit rounded-lg placeholder-gray-300 text-gray-400 outline-none" placeholder="Select">
                                    {
                                        categories.map((item, index) => {
                                            return <option key={index} className="!text-black">{item.categoryName}</option>
                                        })
                                    }
                                </select>
                    </main>
                        ...
                        <h1 className="text-sm font-semibold !text-left ml-3 text-white text-center">
                            City
                                ...
                                {/* <Dropdown
                                    ...
                                    classNames={"py-2 top-12  w-max"}
                                /> */}
                                <select className="bg-transparent block w-full border-none h-fit py-0 rounded-lg placeholder-gray-300 text-gray-400 outline-none">
                                    {
                                        cities.map((city, index) => {
                                            return <option key={index} className="!text-black">{city}</option>
                                        })
                                    }
                                </select>
                    </main>
