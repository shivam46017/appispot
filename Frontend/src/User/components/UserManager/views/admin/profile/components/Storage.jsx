  ...
  return (
    <Card extra={"w-full h-full p-4"}>
      ...
      <div className="mb-auto flex flex-col items-center justify-center ">
        <div className="mt-2 flex items-center justify-center rounded-full bg-lightPrimary p-[26px] text-5xl font-bold text-brand-500 dark:!bg-navy-700 ">
          <BsCloudCheck />
        </div>
        <h4 className="mb-px mt-3 text-2xl font-bold text-navy-700 ">
          Your storage
        </h4>
      ...
      <div className="flex flex-col">
        ...
        <div className="mt-2 flex h-3 w-full items-center rounded-full bg-lightPrimary dark:!bg-navy-700">
          <span className="h-full w-1/2 rounded-full bg-brand-500" />
        </div>
      </div>
    </Card>
  );
