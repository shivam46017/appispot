...
function DiscountMangament() {
  ...
  const [message, setMessage] = useState("")
    ...
    async function sendMessage () {
        const response = await fetch( chats?.length == 0 ? "https://many-aerial-innovation-programming.trycloudflare.com/api/conversation/add" : "https://many-aerial-innovation-programming.trycloudflare.com/api/message/add", {
            method: "POST",
    ...
    async function getAllMessages () {
        const response = await fetch(`https://many-aerial-innovation-programming.trycloudflare.com/api/conversation/getAll?senderId=${localStorage.getItem("userId")}`)
