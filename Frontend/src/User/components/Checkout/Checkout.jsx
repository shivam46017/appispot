...
export default function Checkout() {
  ...
  const checkCoupon = async () => {
    ...
    try {
      const res = await axios.request({
        method: "POST",
        url: "https://many-aerial-innovation-programming.trycloudflare.com/api/verifycoupon",
        data: {
          Code: `${coupon}`,
          venueId: spotId,
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        "https://many-aerial-innovation-programming.trycloudflare.com/api/book-spot",
        data
      );
  ...
  function handleReviewSubmit() {
    async function submitReview() {
      const response = await axios.post(
        "https://many-aerial-innovation-programming.trycloudflare.com/api/review-spot",
        {
          userId: JSON.parse(localStorage.user)._id,
          spotId,
          ...
          <div className="flex flex-col space-y-4 lg:w-fit">
            ...
            <div className="flex flex-col drop-shadow-md rounded-lg border border-slate-300">
              ...
              <div className="flex flex-col p-6 rounded-lg space-y-4">
                ...
                {/* <form action="https://many-aerial-innovation-programming.trycloudflare.com/create-checkout-session" method="post" className="flex flex-col space-y-6"> */}
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="flex items-center relative">
                      ...
                      <button
                        type="button"
                        onClick={checkCoupon}
                        className="font-medium text-[#24b124] absolute z-20 right-5 cursor-pointer"
                      >
                        Apply
                      </button>
                    </div>
          ...
          <div className="flex flex-col space-y-6 p-6 border drop-shadow-md border-slate-300 bg-[#F3F4F6] rounded-lg">
            <div className="flex flex-row space-x-10">
              ...
              <div>
                <img
                  ...
                  src={`https://many-aerial-innovation-programming.trycloudflare.com${spotDetails?.Images[0]}`}
                  alt="spot"
                />
              </div>
            </div>
            <div className="flex flex-col space-y-1">
              <div className="p-2 rounded-lg bg-white drop-shadow-md flex flex-row px-4">
                ...
                <p className="ml-auto">
                  {startDate}, {startTime}:00 - {endTime}:00
                </p>
              </div>
              {/* <div className="p-2 rounded-lg bg-white drop-shadow-md flex flex-row px-4">
                  ...
                  {couponData.couponDetails !== undefined && (
                    <>
                      ...
                      <p className="font-semibold text-right">
                        {couponData ? couponData.couponDetails.Code : ""}{" "}
                        <span className="text-sm ml-1 font-bold text-green-500">
                          {" "}
                          APPLIED!
                        </span>
                        <br />
