...
const AmenitiesSelector = ({ open, onClose, onChange }) => {
...
const CategorySelector = ({ open, onClose, onChange, selected }) => {
...
export default function Edit({ open, viewData, toggleEdit, refresh }) {
  ...
  const handleApproval = async () => {
    const approval = await axios.put(
      `http://localhost:5000/api/admin/spot/${viewData?._id}`,
      {
        isApproved: !viewData?.isApproved,
      }
    );
          ...
          <Grid container>
            ...
            <Grid item xs={9}>
                  ...
                  secondary={
                    <div className="flex flex-col gap-2">
                      <div className="grid grid-cols-6">
                        {viewData?.Amenities?.map((data, i) => {
                          return (
                            <div key={`lister-amenities-${i}`} className="flex items-center gap-2 py-2">
                              <div>
                                <img
                                  height={25}
                                  width={25}
              ...
              <AmenitiesSelector
                ...
                selected={viewData?.Amenities?.map((val) => val._id)}
                onChange={(val) =>
                  setFormValues((prev) => ({
                    ...prev,
                    Amenities: val,
                  ...
                  secondary={
                    <div className="flex flex-col">
                      <div className="grid grid-cols-4">
                        {viewData?.Categories?.map((data, i) => {
                          return (
                            <div key={`categories-listeradmin-${i}`} className="flex items-center gap-2 py-2">
                              <div>
                                <img
                                  height={25}
                                  width={25}
              ...
              <CategorySelector
                ...
                selected={viewData?.Categories?.map((val) => val._id)}
              />
              <Divider />
              <ListItem>
                <ListItemText
              ...
              <List>
                ...
                <ListItem>
                  <FormGroup>
                    ...
                    <TextField
                      placeholder="State"
                      value={viewData?.Location?.state ?? "Connecticut"}
                      onChange={(e) =>
                        setFormValues((prev) => ({
                          ...prev,
                          Location: {
                ...
                <ListItem>
                  <FormGroup>
                    ...
                    <TextField
                      ...
                      value={viewData?.Location?.roadName}
                      onChange={(e) =>
                        setFormValues((prev) => ({
                          ...prev,
                          Location: {
                ...
                <ListItem>
                  <FormGroup>
                    ...
                    <TextField
                      placeholder="Address"
                      value={viewData?.Location?.address}
                      onChange={(e) =>
                        setFormValues((prev) => ({
                          ...prev,
                          Location: {
