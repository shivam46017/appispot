                        ...
                        if (cell.column.Header === "Images") {
                          data = (
                            <div className="flex justify-start mx-4">
                              <AvatarGroup max={3}>
                                {cell.value.map((data, i) => {
                                  return (
                                    <Avatar key={`avatar-image-preview-${i}`} alt="Remy Sharp" src={`${data}`} />
                                  );
                                })}
                              </AvatarGroup>
                            </div>
                          ...
                          data = (
                            <div className="flex justify-start mx-4">
                              <AvatarGroup max={3}>
                                {cell.value.map((data, i) => {
                                  return (
                                    <Avatar key={`avatar-document-preview-${i}`} alt="Remy Sharp" src={`${data}`} />
                                  );
                                })}
                              </AvatarGroup>
                            </div>
                          ...
                          data = (
                            <p className="text-sm font-bold text-navy-700 mx-4">
                              <AvatarGroup max={3}>
                                {cell.value.map((data, i) => {
                                  return (
                                    <Avatar key={`avatar-amentiy-preview-${i}`} alt="Remy Sharp" src={`${data}`} />
                                  );
                                })}
                              </AvatarGroup>
                            </p>
                          ...
                          data = (
                            <p className="text-sm font-bold text-navy-700 mx-4">
                              <AvatarGroup max={3}>
                                {cell.value.map((data, i) => {
                                  return (
                                    <Avatar key={`avatar-category-preview-${i}`} alt="Remy Sharp" src={`${data}`} />
                                  );
                                })}
                              </AvatarGroup>
                            </p>
                        ...
                        if (cell.column.Header === "Opening Time") {
                          data = (
                            <div className="!min-w-[200px] mx-4">
                              {cell?.value?.map((data, i) => {
                                return (
                                  <div className="h-full flex justify-between" key={`Time-${i}`}>
                                    <div>{data?.day}</div>
                                    <div>
                        ...
                        if (cell.column.Header === "Closing Time") {
                          data = (
                            <div className="!min-w-[200px] mx-4">
                              {cell?.value?.map((data, i) => {
                                return (
                                  <div className="h-full flex justify-between" key={`closing-time-${i}`}>
                                    <div>{data?.day}</div>
                                    <div>
                                      {new Date(data?.val).toLocaleTimeString()}
                                    </div>
                        ...
                        if (cell.column.Header === "Holiday's") {
                          data = (
                            <div className="!min-w-[200px] mx-4">
                              {cell?.value?.map((data, i) => {
                                return (
                                  <div className="h-full flex justify-between" key={`holidays-${i}`}>
                                    <div>{data?.day}</div>
                                    <div>{data?.val}</div>
                                  </div>
                                );
