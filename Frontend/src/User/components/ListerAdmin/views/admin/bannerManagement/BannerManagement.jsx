...
function Messages() {
  ...
  const [message, setMessage] = useState("")
    ...
    async function sendMessage () {
        const response = await fetch(myChat?.length == 0 ? "https://many-aerial-innovation-programming.trycloudflare.com/api/conversation/add" : "https://many-aerial-innovation-programming.trycloudflare.com/api/message/add", {
            method: "POST",
    ...
    async function getAllMessages () {
      console.log("Getting messages")
        const response = await fetch(`https://many-aerial-innovation-programming.trycloudflare.com/api/conversation/getAll?receiverId=${localStorage.getItem("userId")}`)
